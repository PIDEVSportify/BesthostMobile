...
public class AjouterRatingGuimobile extends Form {
   public AjouterRatingGuimobile(Form back,int id_rating){
       ...
       Form rate = new Form("Rate",new BoxLayout(BoxLayout.Y_AXIS));
       rate.setUIID("formthree");
       SpanLabel spanLabel=new SpanLabel();
       Label label1_l=new Label(":(:");
       Label label2_l=new Label("you decide.");
       label1_l.setUIID("label11l");
       label2_l.setUIID("label22l");
       ...
       rate.add(label1_l).add(label2_l).add(spanLabel).add(FlowLayout.encloseCenter(finalStarRank)).add(buttonrate);
