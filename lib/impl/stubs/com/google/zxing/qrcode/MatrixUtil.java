...
final class MatrixUtil {
  ...
  static void embedBasicPatterns(Version version, ByteMatrix matrix) throws IllegalArgumentException {
  ...
  static void maybeEmbedVersionInfo(Version version, ByteMatrix matrix) throws IllegalArgumentException {
  ...
  static void embedDataBits(BitArray dataBits, int maskPattern, ByteMatrix matrix)
    ...
    if (bitIndex != dataBits.getSize()) {
      throw new IllegalArgumentException("Not all bits consumed: " + bitIndex + '/' + dataBits.getSize());
    }
  }
  ...
  static void makeTypeInfoBits(ErrorCorrectionLevel ecLevel, int maskPattern, BitArray bits)
    ...
    if (bits.getSize() != 15) {  // Just in case.
      throw new IllegalArgumentException("should not happen but we got: " + bits.getSize());
    }
  }

  // Make bit vector of version information. On success, store the result in "bits" and return true.
  // See 8.10 of JISX0510:2004 (p.45) for details.
  static void makeVersionInfoBits(Version version, BitArray bits) throws IllegalArgumentException {
  ...
  private static void embedDarkDotAtLeftBottomCorner(ByteMatrix matrix) throws IllegalArgumentException {
  ...
  private static void embedPositionDetectionPatternsAndSeparators(ByteMatrix matrix) throws IllegalArgumentException {
